...
<head>
    ...
    <title>Shop Mỹ Phẩm Chất Lượng Việt Nam</title>
</head>
        ...
        <header>
            <div class="container">
                ...
                <section class="menu-right">
                    ...
                    <div class="login">
                        <?php
                        if (isset($_COOKIE['HoVaTen'])) {
                            $username=$_COOKIE['HoVaTen'];
                            if ($_COOKIE["MaQuyen"]=== "ADMIN") {
                                echo '<a style="color:black;" href="">' . $username . '</a>
                                <div class="logout">
